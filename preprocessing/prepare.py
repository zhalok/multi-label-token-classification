...
def prepare_dataset():
    ...
    with open("/home/zhalok/Desktop/giga-tech/datasets/processed_data.json","r") as json_file:
        ...
        processed_df = processed_df.apply(lambda x: process_tag_ids(row=x,label2id=label2id) ,axis=1)
